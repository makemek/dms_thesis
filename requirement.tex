...
\begin{enumerate}
	...
	\item
	Staff shall have read-access to documents.
	...
	\subitem A date when the document is created and modified.
	...
	\item
	Staff should be notified when there is a new pending document forwarded to them.
