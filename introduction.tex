...
For instance, there are three tasks namely \enquote*{A}, \enquote*{B}, \enquote*{C}, and \enquote*{D}.
The workflow executes \enquote*{A} first followed by \enquote*{B}.
Then, it executes \enquote*{C} and \enquote*{D} at the same time.
The execution of \enquote*{A} and \enquote*{B} are sequential because \enquote*{B} have wait for \enquote*{A} to finish first.
On the other hand, the execution of \enquote*{C} and \enquote*{D} are simultaneous because \enquote*{C} and \enquote*{D} execute in parallel.
