...
Furthermore, each public file, they can see all above details and the following details which are related works, document's version, attach files, and all description of the document. %also they can execute them from the permission access control. 
