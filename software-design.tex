...
\textit{DocumentSchema} defines fields that represent a document.
Table \ref{uml:document-templating} describes what each field is, its data type, and its functionality.
