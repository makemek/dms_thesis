...
\begin{tabular}{lll}
	...
	\hline
	Start Event & Indicates where a process begins & \bpmnfig{res/bg-knowledge/bpmn-symbols/start-event-none} \\
	End Event & Indicates where a process will end & \bpmnfig{res/bg-knowledge/bpmn-symbols/end-event-none}
\end{tabular}
\end{table}