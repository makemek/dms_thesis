...
Electronic documents contain descriptive metadata providing additional information on the document such as Document name, Author name, Date etc.
...
\gls{dms} for \gls{ic} use \enquote{Document Store} storage type to manage document's metadata. %TODO explain Document Store
...
The reason to use this storage strategy is that can query values from keys of keys in any depth.
...
%TODO Create exmple document UML
