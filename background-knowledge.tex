...
At that time, \gls{dip} systems are the only available software to satisfy their needs.
...
\begin{wrapfigure}{l}{0.5\textwidth}
	\centering
	\includegraphics[scale=0.75]{res/bg-knowledge/edms-components.png}
...
\gls{ecm}, suites of applications, deals with document and record management.
Nowadays, \gls{edms} acronym is shortened to \gls{dms}.
