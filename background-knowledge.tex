...
\begin{tabular}{m{0.2\textwidth} m{0.5\textwidth} m{0.2\textwidth}}
	...
	\hline
	Start Event & Indicates where a process begins & \bpmnfig[scale=0.015]{\bpmnSymRepo{start-event-none}} \\
	End Event & Indicates where a process will end & \bpmnfig[scale=0.015]{\bpmnSymRepo{end-event-none}} \\
	Task & 
