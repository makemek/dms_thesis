...
\gls{nosql} databases organized data as a hierarchical model with parent-child relationships.
A set of nodes and edges is known as graph.
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{res/bg-knowledge/nosql-hierarchical}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{res/bg-knowledge/nosql-nosql-agregate-uml}
	\caption{An aggregate data model in UML notation \cite[p.~41]{sadalage_fowler_2013}}
