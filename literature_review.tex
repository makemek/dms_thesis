...
\begin{figure}[h!]
	...
	\caption{Eclipse Document Managment 3.1 \cite{docstar}}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.6]{res/literature/screenshot_efilecabinet}
	\caption{eFileCabinet 2014 \cite{efilecabinet}}
\end{figure}
