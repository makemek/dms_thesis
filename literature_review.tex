...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{res/literature/screenshot_contentverse}
	\caption{A screenshot of Contentverse 8.0 \cite{contentverse}}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.6]{res/literature/screenshot_zoho}
